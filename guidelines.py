...
def format_json():
    prompt = f"""
    Generate a list of three made-up titles along with their authors and genres. 
...
def check_condition():
    ...
    If it contains sequence of instructions,re-write those instructions in the following format:
...
def assign_model_calculate_first():
    prompt = f"""
